package com.te.springbatchdemo.config;
...
import com.te.springbatchdemo.repository.EmployeeRepo;
...
public class SpringBatchConfig {
	...
	public FlatFileItemReader<Employee> reader() {
		...
		itemReader.setResource(new FileSystemResource("src/main/resources/Employee-details.csv"));
